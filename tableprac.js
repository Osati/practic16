var fname,lname,email,table_ref,insert_row,fname_col,lname_col,email_col,action_col,all_edit;
var tr, tr1,tr2,cell_value1,cell_value2,cell_value3;
...
function createNewData(){
   ...
   action_col = insert_row.insertCell(3).innerHTML = '<td><a class="btn btn-success" onclick="edit()" >Edit</a>'+
...
function edit(){
   ...
   cell_value1 = tr.cells[0].innerHTML;
   cell_value2 = tr.cells[1].innerHTML;
   cell_value3 = tr.cells[2].innerHTML;
   tr.innerHTML = '<td><input type="text" name="fname1" id="fname1" value='+cell_value1+' class="form-control"></td>'+
